...
export default function ResumePage() {
  const googleDriveFileId = "1CiC2t7x1FByfsMl2mAuOj4HD_jp2h_Y1";
  ...
  return (
    <main className="bg-brand-black min-h-screen text-brand-white p-4 pt-24 flex flex-col items-center">
      <div className="w-full max-w-5xl mb-8">
        <Link
          href="/"
          className="inline-flex items-center text-gray-400 hover:text-brand-orange transition-colors"
        >
          <ArrowLeft size={20} className="mr-2" />
          Back to Home
        </Link>
      </div>
      <h1 className="font-display text-4xl md:text-5xl mb-8 text-brand-orange uppercase">
        Resume
      </h1>
